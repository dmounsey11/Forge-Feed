...
// never committed - see that directory for key.properties.example. Falls
// back to debug signing when the file doesn't exist, so `flutter run` and
...
android {
    namespace = "com.keystoneapps.forgefeed"
    ...
    defaultConfig {
        applicationId = "com.keystoneapps.forgefeed"
